...
// Generates a soft spiral-galaxy texture on an offscreen canvas so the
// scene stays fully self-contained (no external image assets to load).
...
const GALAXIES = [
  ...
  { position: [-300, -40, 260], hue: 200, size: 170 },
  { position: [30, 120, 340], hue: 320, size: 120 },
]
