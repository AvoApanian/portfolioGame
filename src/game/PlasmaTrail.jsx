...
// Fading engine trail rendered as a single Points buffer.
// True per-vertex alpha isn't supported by PointsMaterial, so
// the trail "fades" by darkening each particle's color toward
// black as it ages, which reads as a fade against the space background.
