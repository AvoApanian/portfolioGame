...
// Occasional streaking shooting stars / comets. Each streak is a thin,
// stretched, additive-blended plane oriented along its travel direction.
export default function ShootingStars() {
  const groupRef = useRef(null)

  const streaks = useMemo(() => {
    return new Array(STREAK_COUNT).fill(null).map(() => ({
      ...randomSpawn(),
      mesh: null,
    }))
  }, [])
